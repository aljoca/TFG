...
public abstract class MySqlMigrationUtils {
    ...
    public static String getLabels(List<Label> uEntityName){
        ArrayList<String> labels = new ArrayList<>();
        uEntityName.forEach(label -> labels.add("'" + label.getName() + "'"));
        return String.join(",", labels);
    }

    public static String getLabelsDoubleDot(List<Label> uEntityName){
        ArrayList<String> labels = new ArrayList<>();
        uEntityName.forEach(label -> labels.add(label.getName()));
        return ":" + String.join(":", labels);
    }
